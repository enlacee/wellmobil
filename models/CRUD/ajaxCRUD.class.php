...
class ajaxCRUD{
	...
	function showTable(){
        ...
        */
            ...
            */
            ...
            foreach ($rows as $row){
                ...
                if ($this->delete || (count($this->row_button)) > 0){
					...
					if ($this->orientation == 'vertical'){
						$table_html .= "<th class='vertical'>Accion</th>";
					}

                    $table_html .= "<td>\n";

                    if ($this->delete){
                        $table_html .= "<input type=\"button\" class=\"editingSize\" onClick=\"confirmDelete('$id', '" . $this->db_table . "', '" . $this->db_table_pk ."');\" value=\"Eliminar\" />\n";
                    }
        ...
        if ($this->add){
            $add_html .= "<center>\n";
            $add_html .= "   <input type=\"button\" value=\"Insertar $item\" class=\"btn editingSize\" onClick=\"$('#add_form_$this->db_table').slideDown('slow');\">\n";
